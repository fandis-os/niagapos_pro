...
class HomePenjualView extends StatefulWidget{
  @override
  _HomePenjualViewState createState() => _HomePenjualViewState();
}

class _HomePenjualViewState extends State<HomePenjualView> {
  ...
  void getPreferenches() async {
    prefs = await SharedPreferences.getInstance();
    setState(() {
      username = prefs.getString('username');
      statusUser = prefs.getString('user');
    });
  }
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                      ...
                      child: Container(
                        child: RaisedButton(
                          onPressed: (){
                            Navigator.pushNamed(context, '/toko/TransaksiView');
                          },
                          elevation: 0,
                          shape: RoundedRectangleBorder(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.asset('assets/iconmenu/penjual/inorder.png', width: 100,),
                              Padding(padding: EdgeInsets.only(top: 20)),
                              Text('Order Masuk', style: TextStyle(fontSize: 17, color: Colors.greenAccent),)
                            ],
                          ),
                        ),
                      )
                      ...
                      child: Container(
                        child: RaisedButton(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.asset('assets/iconmenu/penjual/etalase.png', width: 100,),
                              Padding(padding: EdgeInsets.only(top: 20)),
                              Text('Stock Barang', style: TextStyle(fontSize: 17, color: Colors.greenAccent),)
                            ],
                          ),
                        ),
                      )
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                child: Container(
                  alignment: Alignment.center,
                  child: Image.asset('assets/iconmenu/penjual/add.png', width: 20,),
                ),
              ),
            ),
          ],
